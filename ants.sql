...
CREATE TABLE IF NOT EXISTS `ants_comments` (
...
(3, 8, 1450199128, 'hwk603', 1, 1, 'hwk603@qq.com', 'http://hwk603.com', '117.136.70.125', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.80 Safari/537.36', 'HELLO', 'comment', 'approved', 0),
(4, 10, 1450199978, 'hwk603', 1, 3, 'hwk603@qq.com', 'http://hwk603.com', '117.136.70.125', 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.80 Safari/537.36', '你好', 'comment', 'approved', 0);
...
CREATE TABLE IF NOT EXISTS `ants_contents` (
...
CREATE TABLE IF NOT EXISTS `ants_fields` (
...
CREATE TABLE IF NOT EXISTS `ants_metas` (
...
CREATE TABLE IF NOT EXISTS `ants_options` (
...
('siteUrl', 0, 'http://scu.pub/Ants/Ants-back-end'),
('defaultCategory', 0, '1'),
('allowRegister', 0, '1'),
...
('theme:jianshu', 0, 'a:15:{s:8:"logoText";s:0:"";s:9:"avatarUrl";s:53:"http://7xnuhs.com1.z0.glb.clouddn.com/blackmat657.jpg";s:6:"icpNum";s:0:"";s:8:"siteStat";s:0:"";s:7:"bgPhoto";s:0:"";s:12:"avatarDomain";s:22:"http://cn.gravatar.com";s:13:"alipayAccount";s:0:"";s:12:"alipayAmount";s:0:"";s:7:"src_add";s:0:"";s:7:"cdn_add";s:30:"7xnuhs.com1.z0.glb.clouddn.com";s:13:"default_thumb";s:0:"";s:11:"thumb_width";s:3:"200";s:12:"thumb_height";s:3:"140";s:7:"iconCss";s:0:"";s:9:"listStyle";a:2:{i:0;s:7:"excerpt";i:1;s:5:"thumb";}}');
...
CREATE TABLE IF NOT EXISTS `ants_relationships` (
  `cid` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ants_users` (
...
(1, 'admin', '$P$BV.ApWNsGzWOad8iKNXovaYdVDTIkj/', 'hwk603@qq.com', 'http://hwk603.com', 'hwk603', 1449132848, 1450200807, 1450186667, 'administrator', 'c0aed835a20111d253dc00f68baea08f'),
